...
resource "azurerm_linux_web_app" "this" {
  name                = var.name != "" ? "app-${var.name}" : "${var.prefix}-linux-web-app"
  resource_group_name = var.resource_group_name
  location            = var.location
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      vnet_route_all_enabled      = var.enable_subnet
      application_stack {
        docker_image        = lookup(site_config.value, "docker_image", null)
        docker_image_tag    = lookup(site_config.value, "docker_image_tag", null)
  ...
  # lifecycle {
  #   ignore_changes = [
  #     virtual_network_subnet_id ### provider bug
  #   ]
  # }
}
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  name                       = "${var.prefix}-webapp-diagnostic"
...
resource "azurerm_application_insights_web_test" "this" {
  ...
  name                    = "${var.prefix}-appinsights-webtest"
  resource_group_name     = var.resource_group_name
  location                = var.location
  ...
  frequency               = 300
  timeout                 = 60
  enabled                 = var.enable_availability_test
  geo_locations           = ["us-va-ash-azr", "us-ca-sjc-azr"] ### https://docs.microsoft.com/en-us/azure/azure-monitor/app/monitor-web-app-availability#location-population-tags

  configuration = <<XML
<WebTest Name="WebTest1" Id="ABD48585-0831-40CB-9069-682EA6BB3583" Enabled="True" CssProjectStructure="" CssIteration="" Timeout="0" WorkItemIds="" xmlns="http://microsoft.com/schemas/VisualStudio/TeamTest/2010" Description="" CredentialUserName="" CredentialPassword="" PreAuthenticate="True" Proxy="default" StopOnError="False" RecordedResultFile="" ResultsLocale="">
  <Items>
    <Request Method="GET" Guid="a5f10126-e4cd-570d-961c-cea43999a200" Version="1.1" Url="${azurerm_linux_web_app.this.default_hostname}" ThinkTime="0" Timeout="300" ParseDependentRequests="True" FollowRedirects="True" RecordResult="True" Cache="False" ResponseTimeGoal="0" Encoding="utf-8" ExpectedHttpStatusCode="200" ExpectedResponseUrl="" ReportingName="" IgnoreHttpStatusCode="False" />
  </Items>
</WebTest>
XML
}